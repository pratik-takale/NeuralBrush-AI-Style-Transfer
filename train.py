...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str,default='content_dataset',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default='style_dataset',
...
def main():
    ...
    if args.resume and args.decoder_path and args.optimizer_path:
    ...
    for epoch in range(args.epochs):
        ...
        scheduler.step()
        running_loss /= max(1, len(content_dataloader))
        running_closs /= max(1, len(content_dataloader))
        running_sloss /= max(1, len(content_dataloader))
